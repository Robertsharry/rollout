      ...
      <Container>
        <Reveal>
          <div className="glass relative overflow-hidden rounded-3xl px-6 py-16 text-center md:py-20">
            <div
              aria-hidden
              className="pointer-events-none absolute -top-20 -left-20 size-72 rounded-full bg-brass/15 blur-[100px]"
            />
            <div
              aria-hidden
              className="pointer-events-none absolute -right-16 -bottom-24 size-80 rounded-full bg-oxblood-bright/10 blur-[110px]"
            />
            <h2 className="relative font-display text-3xl font-bold tracking-tight text-balance sm:text-4xl md:text-5xl">
              Your squad is already at the table.
            </h2>
